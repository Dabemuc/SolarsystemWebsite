...
const spaceTex = new THREE.TextureLoader().load('textures/2k_stars_milky_way.jpg');
const space = new THREE.Mesh(
  new THREE.SphereGeometry(5000, 24, 18, 0, Math.PI * 2, 0, Math.PI),
  new THREE.MeshStandardMaterial({map:spaceTex})
);
space.material.side = THREE.BackSide;
//scene.add(space);


const sunTex = new THREE.TextureLoader().load('textures/2k_sun.jpg');
...
const gridHelper = new THREE.GridHelper(100, 70);
